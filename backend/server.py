...
app = Flask(__name__)
CORS(app, origins=["https://faradayx.netlify.app"], supports_credentials=True, allow_headers=["Content-Type", "Authorization", "X-Requested-With"], expose_headers=["Content-Type"], methods=["GET", "POST", "OPTIONS", "DELETE", "PUT"])
